...
export default function AboutSection() {
  ...
  return (
    <FadeInSection>
      <section id="about" className="py-16 sm:py-20 md:py-24 overflow-hidden bg-white">
              ...
              <div className="absolute -bottom-8 -left-8 w-64 sm:w-72 rounded-2xl bg-white/90 backdrop-blur-sm shadow-xl p-4 sm:p-6">
                <div className="flex items-center gap-4">
                  <div className="flex-shrink-0 rounded-full bg-sky-100 p-2">
                    <i className="fa-solid fa-heart text-xl text-sky-600"></i>
                  </div>
                  <div>
                    <h3 className="text-lg font-medium text-slate-900">{t("aboutTimelessTributes")}</h3>
                    <p className="mt-1 text-sm text-slate-600">{t("aboutConnectingPastPresent")}</p>
                  </div>
                </div>
              </div>
            </div>
