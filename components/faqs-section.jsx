            ...
            <div className="divide-y divide-slate-200">
              {faqs.map((faq, index) => (
                <div key={index} className="py-5 sm:py-6">
                  ...
                  >
                    <span className="text-base sm:text-lg font-medium text-slate-900">{faq.question}</span>
                    <span className="ml-6 flex h-7 items-center">
                      <i
                        className={`fa-solid fa-chevron-down text-sky-500 transition-transform duration-300 ${openFaq === index ? "rotate-180" : ""}`}
                      ></i>
                    </span>
                  </button>
                  <div
